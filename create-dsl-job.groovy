...
scm.branches = [new BranchSpec("*/build-tags-2")];
...
dslBuilder = new ExecuteDslScripts(scriptLocation=new ExecuteDslScripts.ScriptLocation(value = "false", targets="build-github-branch,attach-remotes", scriptText=""), ignoreExisting=false, removedJobAction=RemovedJobAction.DISABLE);
...
dslProject.scm.branches = [new BranchSpec("*/build-tags-2")];
